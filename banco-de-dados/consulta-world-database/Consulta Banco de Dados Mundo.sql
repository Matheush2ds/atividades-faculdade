...
SELECT Name FROM city WHERE CountryCode = 'USA' ORDER BY Population DESC;

-- 3. Descubra o número total de países em cada continente.
SELECT Continent, COUNT(*) AS NumCountries FROM country GROUP BY Continent;
...
SELECT Name FROM countrylanguage WHERE Language = 'Spanish';
...
SELECT Name FROM country WHERE Name LIKE '%island%';
...
SELECT Name FROM country WHERE Population > 50000000 AND SurfaceArea > 1000000 ORDER BY Population DESC;

-- 14. Calcule a porcentagem da população mundial representada pelos países da Europa.
SELECT SUM(Population) / (SELECT SUM(Population) FROM country) * 100 AS Percentage FROM country WHERE Continent = 'Europe';
...
SELECT Name FROM city WHERE Population BETWEEN 1000000 AND 2000000;

-- 18. Encontre os países com um GNP (Produto Nacional Bruto) per capita superior a 0.008.
SELECT Name FROM country WHERE GNP / Population > 0.008;

-- 19. Calcule o número total de línguas faladas em cada continente.
SELECT Continent, COUNT(DISTINCT Language) AS NumLanguages 
FROM countrylanguage 
JOIN country ON country.Code = countrylanguage.CountryCode 
GROUP BY Continent;

-- 20. Liste os países onde a proporção de falantes de inglês é superior a 80%.
